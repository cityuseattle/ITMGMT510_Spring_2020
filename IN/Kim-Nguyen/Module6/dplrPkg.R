...
#head will print only first 3 rows of the o/p
...
#returns the unique vals in the carrier col
print(distinct(select(flights,carrier)))

#porint the avarage of air time col
print(sumarise(flights, avg_air_time = mean(air_time, na.rm = TRUE)))

#print randome sample of the data frame
