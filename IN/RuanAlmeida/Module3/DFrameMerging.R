...
books <- data.frame(
    ...
    title = c("Exploratory Data Analysis", "Modern Applied Statistics ...", "LISP-STAT", "Spatial Statistics", "Stochastic simulation", "Imteractive Analysis", "An introduction to R"),
